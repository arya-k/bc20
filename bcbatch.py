...
TASKS TO COMPLETE:
[ ] RunnerInfo.get_all_players
[ ] RunnerInfo.get_all_maps
[x] arg_parser in main
[x] RunnerInfo.__init__
[ ] GameResult
[ ] run_game
[ ] print_results
[ ] extra argparse arguments
...
class RunnerInfo:
    def __init__(self, parser):
        ...
        if args.host:  # host style:
            ...
            self.player_ones = args.players or self.get_all_players()

        self.player_twos = args.players or self.get_all_players()
        self.maps = args.maps or self.get_all_maps()
...
GameResult = collections.namedtuple("GameResult", "p1 p2 map winner replay_loc")
...
def build_argparser():
    ...
    # arg_parser.add_argument('--export-csv', help="Exports game data to csv", action='store_true')
    # arg_parser.add_argument("--replay-dir",help="Specify the directory to save the replays in",action="store_const",const="replays/")
